...
(function (exports, bitsy) {
    ...
    var hackOptions = {
        ...
        audio: {
            'bbt': { src: 'src/bitsy/channel_surfing/bbt.mp3', loop: true, volume: 0.5 },
            'friends': { src: 'src/bitsy/channel_surfing/friends.mp3', loop: true, volume: 0.5 },
            'office': { src: 'src/bitsy/channel_surfing/office.mp3', loop: true, volume: 0.5 },
            'jello': { src: 'src/bitsy/channel_surfing/jello.mp3' },
            'harassment_david': { src: 'src/bitsy/channel_surfing/harassment_david.mp3' },
            'harassment_zazie': { src: 'src/bitsy/channel_surfing/harassment_zazie.mp3' },
        },
        ...
        musicByRoom: {
            ...
            0: 'S',
            1: 'bbt', // This room is silent - it will stop music when you enter (see `silenceId` below)
            2: 'friends',
            3: 'office',
        },
