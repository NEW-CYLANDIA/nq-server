...
(function (exports, bitsy) {
    ...
    var hackOptions = {
        ...
        audio: {
            'bbt': { src: '/bridges/src/bitsy/channel_surfing/bbt.mp3', loop: true, volume: 0.5 },
            'friends': { src: '/bridges/src/bitsy/channel_surfing/friends.mp3', loop: true, volume: 0.5 },
            'office': { src: '/bridges/src/bitsy/channel_surfing/office.mp3', loop: true, volume: 0.5 },
            'jello': { src: '/bridges/src/bitsy/channel_surfing/jello.mp3' },
            'harassment_david': { src: '/bridges/src/bitsy/channel_surfing/harassment_david.mp3' },
            'harassment_zazie': { src: '/bridges/src/bitsy/channel_surfing/harassment_zazie.mp3' },
            'gex_out': { src: '/bridges/src/bitsy/channel_surfing/shows_over.wav' },
        },
...
(function (exports, bitsy) {
    ...
    var hackOptions = {
        itemIsPermanent: function (item) {
            return item.name && item.name.includes('genderer')
        },
    };
    ...
    */
    ...
    addDialogTag('impact', function (environment, parameters, onReturn) {
        requestImpact(parameters[0])
        onReturn(null);
    });

    addDialogTag('currency', function (environment, parameters, onReturn) {
        requestCurrency(parameters[0])
        onReturn(null);
    });
